...
app.use('/campgrounds', campgroundsRoutes); //using campgrounds router for endpoint mapping
app.use('/campgrounds/:id/reviews', reviewsRoutes); //using reviews router for endpoint mapping
app.use('/', usersRoutes);
